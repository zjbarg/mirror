...
Route::middleware('auth')->group(function () {
    ...
    Route::get('confirm-password', [Auth\ConfirmPassword\ConfirmablePasswordController::class, 'show'])->name('password.confirm');
    Route::post('confirm-password', [Auth\ConfirmPassword\ConfirmablePasswordController::class, 'store']);
